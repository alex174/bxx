...
use constant SQL_DBI_SOURCE => 'DBI:mysql:database=1796345_main;host=fdb5.awardspace.net'; # DBI data source string (mysql version, put server and database name in here)
use constant SQL_USERNAME => '1796345_main';		# MySQL login name
use constant SQL_PASSWORD => 'thisisagoodpassword';		# MySQL password
